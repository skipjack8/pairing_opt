pub mod g1 {
    use super::super::super::bn256::check_curve_init;
    use super::super::super::mcl::{
        mclBnFp_add, mclBnFp_inv, mclBnFp_sqr, mclBnG1_add, mclBnG1_dbl, mclBnG1_neg,
        mclBnG1_normalize, Fp as mcl_fq, G1 as mcl_g1,
    };
...
pub mod g2 {
    use super::super::super::bn256::check_curve_init;
    use super::super::super::mcl::{
        mclBnFp2_add, mclBnFp2_inv, mclBnFp2_sqr, mclBnG2_add, mclBnG2_dbl, mclBnG2_neg,
        G2 as mcl_g2,
    };
    ...
    impl G2Affine {
        ...
        fn get_generator() -> Self {
            G2Affine {
                x: Fq2::from_fq(
                    super::super::fq::G2_GENERATOR_X_C0,
                    super::super::fq::G2_GENERATOR_X_C1,
                ),
                y: Fq2::from_fq(
                    super::super::fq::G2_GENERATOR_Y_C0,
                    super::super::fq::G2_GENERATOR_Y_C1,
                ),
                infinity: false,
            }
        }
